...
# -*- coding: utf-8 -*-
"""
gazebo_scenario_B3_overtaking.py

Cenário fixo (v2 NO-CLONES): B3_overtaking
"""
import numpy as np
import rospy
...
def build_cfg(start, goal, dm_ref):
    ...
    return dict(
        ...
        obstacles={
        'vegetation1_buoy': dict(pos=along(0.25), vel=(0.35*u).tolist()),
    },
...
if __name__ == '__main__':
    try:
        GazeboScenarioV2Runner('B3_overtaking', build_cfg).spin()
