...
# -*- coding: utf-8 -*-
"""
gazebo_scenario_A4_wall_plus_obstacle.py

Cenário fixo (v2 NO-CLONES): A4_wall_plus_obstacle
"""
import numpy as np
import rospy
...
def build_cfg(start, goal, dm_ref):
    ...
    return dict(
        ...
        obstacles={
        'branche1_buoy': dict(pos=along(0.55) + 1.35*dm_ref*n, vel=[0.0,0.0]),
    },
...
if __name__ == '__main__':
    try:
        GazeboScenarioV2Runner('A4_wall_plus_obstacle', build_cfg).spin()
